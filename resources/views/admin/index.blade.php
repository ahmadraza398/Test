                ...
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">School Buss</p>
                                <h3 class="text-white mb-0 font-weight-500">10 <small class="text-success"><i
                                            class="fa fa-caret-up"></i> +50%</small></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Student Lose</p>
                                <h3 class="text-white mb-0 font-weight-500">50 <small class="text-danger"><i
                                            class="fa fa-caret-down"></i> 9.5%</small></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Head Phone</p>
                                <h3 class="text-white mb-0 font-weight-500">03495118037 <small class="text-danger"><i

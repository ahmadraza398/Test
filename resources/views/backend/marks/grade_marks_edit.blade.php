                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="grade_name" value="{{ $editData->grade_name }}" placeholder="Enter Grade"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{ $editData->grade_point }}" name="grade_point"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{ $editData->start_marks }}" name="start_marks"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{ $editData->end_marks }}" name="end_marks"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{ $editData->start_point }}" name="start_point" placeholder="Enter Start Point"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{ $editData->end_point }}" name="end_point" placeholder="Enter End Point"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{ $editData->remarks }}" name="remarks" placeholder="Give Remarks"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>

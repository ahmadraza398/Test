                            ...
                            <form method="post" action="{{ route('store.employee.attendance') }}">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table table-bordered table-strtiped" style="width: 100%;">
                                                    <thead>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="text-center btn present_all"
                                                                style="display: table-cell; background-color: #5cb85c; border-radius: 0%;">
                                                                <strong>Present</strong>
                                                            </th>
                                                            <th class="text-center btn leave_all"
                                                                style="display: table-cell; background-color: #0275d8 ; border-radius: 0%;">
                                                                Leave</th>
                                                            <th class="text-center btn absent_all"
                                                                style="display: table-cell; background-color: #d9534f; border-radius: 0%;">
                                                                Absent</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
